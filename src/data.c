...
/*   Updated: 2024/06/13 15:16:58 by mrusu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	data_init(t_simulation *simulation)
{
	...
	pthread_mutex_init(&simulation->sim_mutex, NULL); // sync ready flag ..only?
...
void	philo_init(t_simulation *simulation)
{
	...
	while (++i < simulation->philo_nbr)
	{
		...
		pthread_mutex_init(&philo->philo_mutex, NULL); //added for meal index
	}
}
